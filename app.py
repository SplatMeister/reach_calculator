...
# Streamlit config
st.set_page_config(page_title="Reach Planner Analyzer", layout="centered")
...
# Title
st.title("📊 Reach Planner Analyzer")
st.write("Select the platform and upload your planner file to analyze reach vs budget performance.")

# Sidebar: Platform selector
platform = st.sidebar.radio("📌 Select Platform", ["Meta", "Google"])
...
# META LOGIC
# ================================
if platform == "Meta" and uploaded_file:
    try:
        # Load file
        ...
        if not frequency_map:
            st.error("❌ No valid frequency columns found.")
            st.stop()
        ...
        summary = pd.DataFrame({
            "Metric": ["Maximum Reach", "Optimum Reach (Kneed)", f"{custom_percent}% Reach"],
...
# ================================
# GOOGLE LOGIC PLACEHOLDER
# ================================
elif platform == "Google":
    st.info("📌 Google Reach Planner support will be added soon. Please select 'Meta' to begin.")
